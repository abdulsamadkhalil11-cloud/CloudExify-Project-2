...
/**
 * Embeds the canonical DDL (identical to database/schema_sqlite.sql) as
 * compiled-in text blocks so first-run table creation never depends on a
 * classpath resource or working-directory path being right. The .sql file
 * in database/ is the human-readable copy for manual setup / grading;
 * this is the machine copy the app actually runs.
 */
